...
set Library     "hls"
set IPName      "hash_controller"
set Version     "1.0"
set DisplayName "Hash_controller"
set Revision    "0"
set Description "An IP generated by Vitis HLS"
set Device      "virtexuplushbm"
set AutoFamily  ""
set Taxonomy    "/VITIS_HLS_IP"
set target_part "xcvu35p-fsvh2892-2L-e"
set target_lang "verilog"
set has_xpm_memory "0"
set has_blackbox "false"
set sdx_kernel_type "hls"
set xo_kernel_name "hash_controller"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/quarky/hash_controller/solution1"
set debug_dir "/home/quarky/hash_controller/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {hash_controller_flow_control_loop_pipe
...
## Variables
set Top "hash_controller"
set TopNoPrefix "hash_controller"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_EN RW 0 {Enable Channel 2 (ap_local_deadlock) Interrupt.  0 = Disabled, 1 = Enabled.}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_ST RTOW 0 {Channel 2 (ap_local_deadlock) Interrupt Status. 0 = No Channel 2 input interrupt, 1 = Channel 2 input interrup}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x10 rd_0_offset_1 W 0x0 "Data signal of rd_0_offset" {{0 32 rd_0_offset W 0 "Bit 31 to 0 of rd_0_offset"}}} {0x14 rd_0_offset_2 W 0x0 "Data signal of rd_0_offset" {{0 32 rd_0_offset W 0 "Bit 63 to 32 of rd_0_offset"}}} {0x1c rd_1_offset_1 W 0x0 "Data signal of rd_1_offset" {{0 32 rd_1_offset W 0 "Bit 31 to 0 of rd_1_offset"}}} {0x20 rd_1_offset_2 W 0x0 "Data signal of rd_1_offset" {{0 32 rd_1_offset W 0 "Bit 63 to 32 of rd_1_offset"}}} {0x28 wr_0_offset_1 W 0x0 "Data signal of wr_0_offset" {{0 32 wr_0_offset W 0 "Bit 31 to 0 of wr_0_offset"}}} {0x2c wr_0_offset_2 W 0x0 "Data signal of wr_0_offset" {{0 32 wr_0_offset W 0 "Bit 63 to 32 of wr_0_offset"}}} {0x34 wr_1_offset_1 W 0x0 "Data signal of wr_1_offset" {{0 32 wr_1_offset W 0 "Bit 31 to 0 of wr_1_offset"}}} {0x38 wr_1_offset_2 W 0x0 "Data signal of wr_1_offset" {{0 32 wr_1_offset W 0 "Bit 63 to 32 of wr_1_offset"}}} {0x40 first W 0x0 "Data signal of first" {{0 1 first W 0 "Bit 0 to 0 of first"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 last W 0x0 "Data signal of last" {{0 1 last W 0 "Bit 0 to 0 of last"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 block_header_1 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 31 to 0 of block_header"}}} {0x54 block_header_2 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 63 to 32 of block_header"}}} {0x58 block_header_3 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 95 to 64 of block_header"}}} {0x5c block_header_4 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 127 to 96 of block_header"}}} {0x60 block_header_5 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 159 to 128 of block_header"}}} {0x64 block_header_6 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 191 to 160 of block_header"}}} {0x68 block_header_7 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 223 to 192 of block_header"}}} {0x6c block_header_8 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 255 to 224 of block_header"}}} {0x70 block_header_9 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 287 to 256 of block_header"}}} {0x74 block_header_10 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 319 to 288 of block_header"}}} {0x78 block_header_11 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 351 to 320 of block_header"}}} {0x7c block_header_12 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 383 to 352 of block_header"}}} {0x80 block_header_13 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 415 to 384 of block_header"}}} {0x84 block_header_14 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 447 to 416 of block_header"}}} {0x88 block_header_15 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 479 to 448 of block_header"}}} {0x8c block_header_16 W 0x0 "Data signal of block_header" {{0 32 block_header W 0 "Bit 511 to 480 of block_header"}}} {0x94 target_1 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 31 to 0 of target"}}} {0x98 target_2 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 63 to 32 of target"}}} {0x9c target_3 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 95 to 64 of target"}}} {0xa0 target_4 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 127 to 96 of target"}}} {0xa4 target_5 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 159 to 128 of target"}}} {0xa8 target_6 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 191 to 160 of target"}}} {0xac target_7 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 223 to 192 of target"}}} {0xb0 target_8 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 255 to 224 of target"}}} {0xb4 target_9 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 287 to 256 of target"}}} {0xb8 target_10 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 319 to 288 of target"}}} {0xbc target_11 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 351 to 320 of target"}}} {0xc0 target_12 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 383 to 352 of target"}}} {0xc4 target_13 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 415 to 384 of target"}}} {0xc8 target_14 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 447 to 416 of target"}}} {0xcc target_15 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 479 to 448 of target"}}} {0xd0 target_16 W 0x0 "Data signal of target" {{0 32 target W 0 "Bit 511 to 480 of target"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_rd_0 m_axi_rd_1 m_axi_wr_0 m_axi_wr_1 ingress_0 ingress_1 egress_0 egress_1 golden_fifo_0 golden_fifo_1"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_rd_0 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_rd_0"
        data_width "256"
        param_prefix "C_M_AXI_RD_0"
    ...
    m_axi_rd_1 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_rd_1"
        data_width "256"
        param_prefix "C_M_AXI_RD_1"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 256 WSTRB 32 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 256 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_wr_0 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_wr_0"
        data_width "256"
        param_prefix "C_M_AXI_WR_0"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 256 WSTRB 32 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 256 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_wr_1 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_wr_1"
        data_width "256"
        param_prefix "C_M_AXI_WR_1"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 256 WSTRB 32 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 256 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 2.22 machine 64 combinational 0 latency 67108877 II x}
