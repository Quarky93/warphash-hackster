# 1 "hash_controller/hash_controller.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "hash_controller/hash_controller.cpp" 2
...
# 2 "hash_controller/hash_controller.cpp" 2
...
# 242 "/tools/Xilinx/Vitis_HLS/2021.2/common/technology/autopilot/ap_axi_sdata.h" 2
namespace hls {
...
# 3 "hash_controller/hash_controller.cpp" 2
...
void ingress(hls::stream<packet_t> &ingress, const ap_uint<256> *gmem, int dest, bool first, ap_uint<512> block_header) {
 VITIS_LOOP_13_1: for (int i = 0; i < 33554432; i++) {
#pragma HLS PIPELINE II=2
 packet_t packet;
  if (first == false) {
   ...
   packet.data(31, 0) = block_header(31, 0) + (i + 33554432 * dest);
  }
  packet.dest = dest;
...
void egress(ap_uint<256> *gmem, hls::stream<packet_t> &egress, int dest, bool last, ap_uint<512> target, hls::stream<ap_uint<32>> &golden_fifo) {
 VITIS_LOOP_29_1: for (int i = 0; i < 33554432; i++) {
#pragma HLS PIPELINE II=2
 packet_t packet = egress.read();
  if (last == false) {
   ...
   golden_fifo.write(i + 33554432 * dest);
  }
 }
}
...
__attribute__((sdx_kernel("hash_controller", 0))) void hash_controller(
...
#pragma HLSDIRECTIVE TOP name=hash_controller
# 84 "hash_controller/hash_controller.cpp"
